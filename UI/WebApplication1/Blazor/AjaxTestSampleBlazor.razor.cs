...
{
    public partial class AjaxTestSampleBlazor
    {
        ...
        private async Task<AjaxTestDataWebModel> GetDataFromServer(int? id, string msg, int Delay = 1000)
        {
            await Task.Delay(Delay);
            return new AjaxTestDataWebModel
            {
                Id = id ?? 1,
                Message = msg,
